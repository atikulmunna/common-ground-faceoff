...
ARG NEXT_PUBLIC_ENABLE_SMS_MFA=false
ARG NEXT_PUBLIC_GOOGLE_AUTH_ENABLED=false
ARG NEXT_PUBLIC_MICROSOFT_AUTH_ENABLED=false
ENV NEXT_PUBLIC_API_BASE_URL=${NEXT_PUBLIC_API_BASE_URL} \
    NEXT_PUBLIC_ENABLE_REGISTRATION=${NEXT_PUBLIC_ENABLE_REGISTRATION} \
    NEXT_PUBLIC_ENABLE_SMS_MFA=${NEXT_PUBLIC_ENABLE_SMS_MFA} \
    NEXT_PUBLIC_GOOGLE_AUTH_ENABLED=${NEXT_PUBLIC_GOOGLE_AUTH_ENABLED} \
    NEXT_PUBLIC_MICROSOFT_AUTH_ENABLED=${NEXT_PUBLIC_MICROSOFT_AUTH_ENABLED}
